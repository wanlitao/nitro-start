...
export function handlersOpenApiMeta() {
  return {
    name: "nitro-ext:handlers-openapi-meta",
    buildStart() {
      console.log("nitro ext rollup plugin:handlers-openapi-meta build start");
    },
    buildEnd() {
      console.log("nitro ext rollup plugin:handlers-openapi-meta build end");
    },
